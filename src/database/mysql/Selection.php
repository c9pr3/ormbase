...
class Selection implements iSelection {
	...
	public function getQuery() {
		if ( !$this->mode ) {
			throw new \wplibs\exception\DatabaseException( 'Empty query not allowed' );
		}
	...
	private function prepareValue( $value ) {
		...
		elseif ( is_object( $value ) ) {
			throw new \wplibs\exception\DatabaseException( "Cannot insert object: " . var_export( $value, true ) );
		}
		#
	...
	protected function buildQueryReplace() {
		throw new \wplibs\exception\DatabaseException( 'replace not implemented yet' );
	}
